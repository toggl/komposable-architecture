...
class StoreEffectsTests : StoreCoroutineTest() {
    @Test
    fun `multiple effects can continue sending actions simultaneously`() =
        runTest {
    ...
    @Test
    fun `effects are cancelled correctly in flight`() =
        runTest {
            val effect1Flow = MutableStateFlow(TestAction.ChangeTestProperty("0"))
            val effect1 =
                Effect {
    ...
    @Test
    fun `effects are cancelled correctly with cancel effect`() =
        runTest {
            val effect1Flow = MutableStateFlow(TestAction.ChangeTestProperty("0"))
            val effect1 =
                Effect {
    ...
    @Test
    fun `all actions are reduced before any effect gets processed`() =
        runTest {
