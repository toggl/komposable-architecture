...
class EffectCancellationTests {
    @Test
    fun `effects can be canceled with cancel effect`() =
        runTest {
    ...
    @Test
    fun `multiple effects with the same id should all be canceled at the same time`() =
        runTest {
            val effect1Flow = MutableStateFlow(0)
            val effect1 =
                Effect {
    ...
    @Test
    fun `merged effect should complete only after all effects are cancelled`() =
        runTest {
            val effect1Flow = MutableStateFlow(0)
            val effect1 =
                Effect {
    ...
    @Test
    fun `multiple effects with the same id should work in parallel when cancelInFlight = false`() =
        runTest {
            val effect1Flow = MutableStateFlow(0)
            val effect1 =
                Effect {
    ...
    @Test
    fun `multiple effects with the same id should cancel each other out when cancelInFlight = true`() =
        runTest {
            val effect1Flow = MutableStateFlow(0)
            val effect1 =
                Effect {
    ...
    @Test
    fun `all the effects are cancelled when cancelAll is used`() =
        runTest {
            val effect1Flow = MutableStateFlow(0)
            val effect1 =
                Effect {
