...
object StateSources {
    ...
    val settingsStateWithInvalidMapping =
        SourceFile.kotlin(
            "SettingsState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val settingsStateWithNestedMapping =
        SourceFile.kotlin(
            "SettingsState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val settingsStateWithDeeperNestedMapping =
        SourceFile.kotlin(
            "SettingsState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val settingsStateWithTwoNestedMapping =
        SourceFile.kotlin(
            "SettingsState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val settingsStateWithTwoValues =
        SourceFile.kotlin(
            "SettingsState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val appStateMultipleChildStates =
        SourceFile.kotlin(
            "AppState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val appStateWithNestedValueInSeparateFile =
        SourceFile.kotlin(
            "AppState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val appStateWithTwoNestedValues =
        SourceFile.kotlin(
            "AppState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val appStateWithDeeperNestedValue =
        SourceFile.kotlin(
            "AppState.kt",
            """
            package com.toggl.komposable.compiler
    ...
    val appStateWithNestedNonDataClassValue =
        SourceFile.kotlin(
            "AppState.kt",
            """
            package com.toggl.komposable.compiler
