...
class ReducerTestExtensionsTests {
    ...
    @Test
    fun `testReduce calls the right methods`() =
        runTest {
    ...
    @Test
    fun `testReduceState calls the right methods`() =
        runTest {
    ...
    @Test
    fun `testReduceEffects calls the right methods`() =
        runTest {
    ...
    @Test
    fun `testReduceNoEffects calls the right methods`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
    ...
    @Test
    fun `testReduceNoEffects should fail when some effects are returned`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
                    every { reduce(any(), any()) } returns ReduceResult(initState, returnedEffects)
    ...
    @Test
    fun `testReduceNoOp calls the right methods`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
                    every { reduce(any(), any()) } returns ReduceResult(initState, NoEffect)
    ...
    @Test
    fun `testReduceNoOp fails when some effects are returned`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
                    every { reduce(any(), any()) } returns ReduceResult(initState, returnedEffects)
    ...
    @Test
    fun `testReduceNoOp fails when state has been changed`() =
        runTest {
            val reducer =
    ...
    @Test
    fun `testReduceException calls the right methods`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
    ...
    @Test
    fun `testReduceException fails when non expected exception is thrown`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
    ...
    @Test
    fun `testReduceException fails when no exception is thrown`() =
        runTest {
            val reducer =
                mockk<Reducer<TestState, TestAction>> {
                    every { reduce(any(), any()) } returns ReduceResult(initState, NoEffect)
